  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3">
        <div className="text-xs text-on-surface-variant font-medium">Similarity</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <div className="text-[0.65rem] font-bold uppercase tracking-widest text-on-surface-variant mb-2">Expected</div>
          <div className="bg-surface-container rounded-md p-3 text-xs text-on-surface font-mono whitespace-pre-wrap min-h-[80px] border border-outline-variant/10">
            {expectedAnswer || <span className="text-on-surface-variant/50 italic">No expected answer provided</span>}
          </div>
        </div>
        <div>
          <div className="text-[0.65rem] font-bold uppercase tracking-widest text-on-surface-variant mb-2">Actual</div>
          <div className="bg-surface-container rounded-md p-3 text-xs text-on-surface font-mono whitespace-pre-wrap min-h-[80px] border border-outline-variant/10">
            {actualAnswer || <span className="text-on-surface-variant/50 italic">No result text</span>}
          </div>
        </div>
      </div>
    </div>
